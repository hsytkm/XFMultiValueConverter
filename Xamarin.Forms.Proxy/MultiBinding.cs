 ...
 *   https://forums.xamarin.com/discussion/64727/whats-the-equivilent-to-wpfs-imultivalueconverter
 * 
 * MultiBinding in Xamarin.Forms
 *   https://intellitect.com/multibinding-in-xamarin-forms/
 * 
 * Github: Keboo / Xamarin.Forms.Proxy
 *   https://github.com/Keboo/Xamarin.Forms.Proxy
 */
            ...
            bool fromBindingContextChanged = false)
        {
            ...
            foreach (BindingBase binding in Bindings)
            {
                var property = BindableProperty.Create($"{nameof(MultiBinding)}Property-{Guid.NewGuid():N}", typeof(object),
                    typeof(MultiBinding), default, propertyChanged: (bindableObj, o, n) =>
                    {
